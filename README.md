...
This challenge will show how index performance vary with shard size for autogenerated IDs and UUIDs. t will also show how query performance and memory usage varies with shard size.
